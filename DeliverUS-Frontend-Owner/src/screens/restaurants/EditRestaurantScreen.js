...
export default function EditRestaurantScreen ({ navigation, route }) {
  ...
  const [initialRestaurantValues, setInitialRestaurantValues] = useState({ name: null, description: null, address: null, postalCode: null, url: null, shippingCosts: null, email: null, phone: null, discount: null, discountCode: null, restaurantCategoryId: null, logo: null, heroImage: null })
  const validationSchema = yup.object().shape({
    ...
    discount: yup
      .number()
      .positive()
      .max(99, 'Discount cannot be 100 or higher'),
    discountCode: yup
      .string()
      .nullable()
